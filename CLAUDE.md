...
src/components/MediaPlayer.jsx source-aware clip dispatcher: picks YouTube/Spotify/file from the URL (lib/model mediaSource); one contract (start/end trim, audioOnly, pauseSignal). Used by PlayView + RoundBody
