...
export const NERD_QUIZ = {
  ...
  rounds: [
    ...
    },
    {
      id: "n8",
      type: "choice",
      title: "Lore Multiple Choice",
      timer: 20,
      questions: [
        {
          id: "nch1",
          q: "Which region of Runeterra is Jinx and Vi's home?",
          options: ["Demacia", "Ionia", "Zaun", "Noxus"],
          correct: 2,
          points: 10,
        },
        {
          ...
          options: ["Millennium Falcon", "Slave I", "X-wing", "Star Destroyer"],
          correct: 0,
          points: 10,
        },
        {
          id: "nch3",
          q: "Which company developed the original Half-Life?",
          options: ["id Software", "Valve", "Epic Games", "Blizzard"],
          correct: 1,
          points: 10,
        },
      ],
    },
    {
      ...
      questions: [
        {
          id: "nn1",
          q: "How many champions are playable in League of Legends as of 2024?",
          answer: 168,
          unit: "champions",
          points: 15,
        },
        {
          id: "nn2",
          q: "In what year was the original Pokémon Red & Green released in Japan?",
          answer: 1996,
          unit: "",
          points: 15,
        },
        {
          id: "nn3",
          q: "How many blocks tall is the maximum build height in modern Minecraft?",
          answer: 320,
          unit: "blocks",
          points: 15,
        },
